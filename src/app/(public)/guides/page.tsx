        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 reveal">
          {guides.map((guide, i) => (
            <div key={i} className="flex flex-col gap-8 group">
              <div className="aspect-square bg-white/[0.02] border border-border rounded-xl flex items-center justify-center group-hover:border-accent/20 transition-all overflow-hidden relative">
