          ...
          <div className="p-8 lg:p-12 space-y-8 relative z-10">
            ...
            <div className="grid grid-cols-1 gap-4">
              <CustomButton
                ...
                className="w-full flex items-center justify-center gap-2 py-6 bg-white/5 hover:bg-white/10 border border-border rounded-2xl transition-all"
              >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex justify-end">
                    <button
                      type="button"
                      className="text-xs text-white/40 hover:text-accent transition-colors disabled:opacity-50"
                      disabled={isLoading || !!loadingProvider}
                    >
                      Mot de passe oublié ?
                    </button>
              ...
              <div className="pt-4">
                <CustomButton
                  ...
                  className="h-14 rounded-xl font-bold text-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                >
              ...
              <div className="text-center">
                <p className="text-white/40 text-sm">
                  ...
                  <button
                    ...
                    className="text-accent hover:text-accent-bright font-medium transition-colors disabled:opacity-50"
                    disabled={isLoading || !!loadingProvider}
                  >
                    Créer un compte
                  </button>
